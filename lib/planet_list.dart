import 'package:space_app/planet_modal.dart';

List<PlanetModal> planetList = [
  PlanetModal(
    planetName: 'Sun',
    planetImgeUrl: 'assets/sun.png',
  ...
  PlanetModal(
    planetName: 'Mercury',
    planetImgeUrl: 'assets/mercury.png',
    planetAbout:
        "The Sun is the heart of our solar system, a massive ball of plasma that provides heat, light, and energy to everything within its gravitational pull. Its immense size and temperature are fueled by nuclear fusion, a process that combines hydrogen atoms into helium, releasing vast amounts of energy. The Sun's magnetic field, which is constantly changing, influences solar activity like sunspots and solar flares, affecting space weather and potentially disrupting Earth-based technologies.",
  ...
  PlanetModal(
    planetName: 'Venus',
    planetImgeUrl: 'assets/venus.png',
    planetAbout:
  ...
  PlanetModal(
    planetName: 'Earth',
    planetImgeUrl: 'assets/earth.png',
  ...
  PlanetModal(
    planetName: 'Jupiter',
    planetImgeUrl: 'assets/jupiter.png',
  ...
  PlanetModal(
    planetName: 'Saturn',
    planetImgeUrl: 'assets/saturn.png',
  ...
  PlanetModal(
    planetName: 'Uranus',
    planetImgeUrl: 'assets/uranus.png',
  ...
  PlanetModal(
    planetName: 'Neptune',
    planetImgeUrl: 'assets/neptune.png',
